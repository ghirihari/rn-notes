      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
            ...
            <View style={styles.buttonCont}>
                <Pressable style={[styles.button,{backgroundColor:'#404040'}]} onPress={() => {props.setModalVisible((modalVisible)=>!modalVisible); props.navigate('Add')}}>
                    <Icon name='sticky-note' size={50} style={styles.icon}/>
